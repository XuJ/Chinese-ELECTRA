...
class CCKS42EC(ClassificationTask):
  ...
  def __init__(self, config: configure_finetuning.FinetuningConfig, tokenizer):
    ...
    #                                ["股东减持_1", "股东减持_2", "股东减持_3", "股东减持_4", "股东减持_5", "股权质押_1", "股权质押_2", "股权质押_3",
    #                                 "股权质押_4", "股权质押_5", "股权冻结_1", "股权冻结_2", "股权冻结_3", "股权冻结_4", "股权冻结_5", "股东增持_1",
    #                                 "股东增持_2", "股东增持_3", "股东增持_4", "股东增持_5", "重大资产损失_1", "高层死亡_1", "重大对外赔付_1",
    #                                 "重大安全事故_1", "破产清算_1"])
    super(CCKS42EC, self).__init__(config, "ccks42ec", tokenizer,
